...
*Uwaga: Zaczniemy od modularnego monolitu, żeby skupić się na kodzie domenowym, a potem rozerwiemy go na mikroserwisy. To najzdrowsza ścieżka rozwoju.*
- [x] Struktura projektu (Go Standard Layout). <!-- id: 4 -->
- [x] Implementacja domeny `Events` (Structs, Entities). <!-- id: 5 -->
- [ ] Implementacja warstwy dostępu do danych (Postgres + pgx/sqlc). <!-- id: 6 -->

## Phase 2: API & Communication
- [ ] Wystawienie REST API (net/http + chi). <!-- id: 7 -->
